---
path: '/simple-coffee-app'
date: '2018-12-20T19:22:31.723Z'
title: 'Making a simple coffee ordering app'
featuredImage: './featured.jpeg'
headerImage: './header.jpeg'
tags: [android, basics, java, git, github, Linux, open source, Ubuntu]
excerpt: 'Learn the basics of creating an Android App using Java'
---
